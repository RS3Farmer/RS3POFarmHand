export const RequiredImages: React.FC = () => {
  ...
  //TeleportImages
  require("./../assets/Images/TeleportImages/AlkharidTeles.png");
  require("./../assets/Images/TeleportImages/AnachroniaEast.png");
  require("./../assets/Images/TeleportImages/ArdougneSouthTeles.png");
  require("./../assets/Images/TeleportImages/BrimhavenNorth.png");
  require("./../assets/Images/TeleportImages/CatherbyAllotmentTeles.png");
  require("./../assets/Images/TeleportImages/CatherbyEastTeles.png");
  require("./../assets/Images/TeleportImages/ChampionGuildSouthTeles.png");
  require("./../assets/Images/TeleportImages/ChampionsGuildWestTeles.png");
  require("./../assets/Images/TeleportImages/CityOfUmTeles.png");
  require("./../assets/Images/TeleportImages/DraynorVillageTeles.png");
  require("./../assets/Images/TeleportImages/EastPortSarimTeles.png");
  require("./../assets/Images/TeleportImages/EntranaTeles.png");
  require("./../assets/Images/TeleportImages/FaladorAllotmentTeles.png");
  require("./../assets/Images/TeleportImages/FaladorParkTeles.png");
  ...
  require("./../assets/Images/TeleportImages/LumbridgeGenTeles.png");
  require("./../assets/Images/TeleportImages/LunarIsleTeles.png");
  require("./../assets/Images/TeleportImages/ManorFarmTeleSTree.png");
  require("./../assets/Images/TeleportImages/McGruborWoodsTeles.png");
  require("./../assets/Images/TeleportImages/MenaphosTeles.png");
  require("./../assets/Images/TeleportImages/NECanifisTeles.png");
  require("./../assets/Images/TeleportImages/NortherAnachroniaTeles.png");
  require("./../assets/Images/TeleportImages/Prifddinas(Center)Teles.png");
  require("./../assets/Images/TeleportImages/Prifddinas(Crwys District).png");
  require("./../assets/Images/TeleportImages/Prifddinas(Meilyr District).png");
  require("./../assets/Images/TeleportImages/Prifddinas(Trahaearn District)Teles.png");
  require("./../assets/Images/TeleportImages/PriffTeleportsCrwys.png");
  require("./../assets/Images/TeleportImages/RimmingtonTeles.png");
  require("./../assets/Images/TeleportImages/SouthEastEtceteria.png");
  require("./../assets/Images/TeleportImages/SouthWestEtceteria.png");
  require("./../assets/Images/TeleportImages/TaiBwoTeles.png");
  require("./../assets/Images/TeleportImages/TaverlyPotatoeTele.png");
  require("./../assets/Images/TeleportImages/TaverlyTreePatchTeles.png");
  require("./../assets/Images/TeleportImages/TirannwnTeles.png");
  require("./../assets/Images/TeleportImages/TrollheimTeles.png");
  require("./../assets/Images/TeleportImages/TuaiLeitTeles.png");
  require("./../assets/Images/TeleportImages/VarrockTreePatchTeles.png");
  require("./../assets/Images/TeleportImages/WestCanafisTeles.png");
  require("./../assets/Images/TeleportImages/WestTreeGnomeVillageTeles.png");
  require("./../assets/Images/TeleportImages/Wildernesslvl22Teles.png");
  require("./../assets/Images/TeleportImages/Wildernesslvl38Teles.png");
  require("./../assets/Images/TeleportImages/WoodCuttersGroveTeles.png");
  require("./../assets/Images/TeleportImages/YanilleTeles.png");
